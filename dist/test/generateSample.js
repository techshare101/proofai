...
var generatePDF_1 = require("../utils/generatePDF");
var mockData = {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, generatePDF_1.generatePDF)(mockData, mockOptions)];
                case 2:
                    resultPath = _a.sent();
                ...
                case 3:
                    error_1 = _a.sent();
                    console.error('❌ Error generating sample PDF:', error_1);
